...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference("Device.count") do
      post devices_url, params: { device: { account_id: @device.account_id, name: @device.name } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { account_id: @device.account_id, name: @device.name } }
